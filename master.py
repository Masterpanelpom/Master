...
# ==========================================
# MASTER HTML WITH 3-LINE MENU & 4 OPTIONS
# ==========================================
...
<body class="text-slate-100 min-h-screen flex">
    ...
    <aside id="masterSidebar" class="p-5 flex flex-col justify-between overflow-y-auto">
        <div class="space-y-6">
            ...
            <!-- The 4 Requested Options with Icons -->
...
<body class="text-slate-100 min-h-screen flex">
    ...
    <main class="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        ...
        <div class="p-4 md:p-8 max-w-5xl w-full mx-auto space-y-6">
            ...
            <!-- UNIFIED FORM FOR BOT TOKEN AND MEDIA (FIXES SAVE BUTTON ISSUE) -->
            <form id="botSaveForm" method="POST" action="/admin/save">
                ...
                <!-- TAB: MEDIA & GREETINGS (MULTIPLE VIDEO SELECT & DIRECT UPLOAD) -->
                ...
                <!-- Direct Save Button placed inside the form to eliminate submission errors -->
            ...
            <!-- Direct Video Upload Dropzone (AJAX, Outside main form) -->
