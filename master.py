...
class MultiBotEngine:
    ...
    def _attach_handlers(self, dp: Dispatcher, slug: str):
        ...
        # Unified receiver supporting both photo and document image screenshots
...
# ==========================================
# HTML TEMPLATES (AUTHENTIC 1:1 REPLICATION)
# ==========================================
...
<body class="text-slate-100 min-h-screen flex">
    ...
    <!-- Navigation Drawer with exact original branding -->
...
async def tenant_admin_panel(
    ...
    # Dynamically rewrite form action endpoints to keep each tenant isolated
    scoped_html = (
        DASHBOARD_PAGE
