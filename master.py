...
# FULL, UNABRIDGED 1:1 CYBERPUNK CLIENT DASHBOARD TEMPLATE WITH ALL MODALS & SCRIPTS
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <span class="font-tech text-[10px] tracking-wider text-cyan-300 uppercase block">VIP Access Bot</span>
                    </div>
                </div>
...
async def tenant_admin_panel(
    ...
    # Dynamically scope every action, fetch URL, and pagination href to this exact tenant
    scoped_html = (
        DASHBOARD_PAGE
...
async def tenant_save_general_settings(
    ...
    return RedirectResponse(url=f"/c/{slug}/admin?message=Configurations+applied+and+saved&tab=tab-bot", status_code=status.HTTP_303_SEE_OTHER)
